...
/**
 * Model tests for CompletionOptions
 */
public class CompletionOptionsTest {
    private final CompletionOptions model = new CompletionOptions();
