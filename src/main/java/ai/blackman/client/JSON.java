...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new ai.blackman.client.model.Choice.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.blackman.client.model.CompletionOptions.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.blackman.client.model.CompletionRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.blackman.client.model.CompletionResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.blackman.client.model.InvalidateResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.blackman.client.model.Message.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.blackman.client.model.SemanticCacheConfig.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.blackman.client.model.SemanticCacheStats.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.blackman.client.model.SubmitFeedbackRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.blackman.client.model.SubmitFeedbackResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.blackman.client.model.Usage.CustomTypeAdapterFactory());
