...
public class InvalidateResponse {
  ...
  public InvalidateResponse message(@javax.annotation.Nonnull String message) {
  ...
  public boolean equals(Object o) {
    ...
    InvalidateResponse invalidateResponse = (InvalidateResponse) o;
    return Objects.equals(this.message, invalidateResponse.message);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InvalidateResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InvalidateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvalidateResponse is not found in the empty JSON string", InvalidateResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InvalidateResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InvalidateResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InvalidateResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvalidateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvalidateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvalidateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvalidateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<InvalidateResponse>() {
           @Override
           public void write(JsonWriter out, InvalidateResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InvalidateResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InvalidateResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InvalidateResponse
   * @throws IOException if the JSON string is invalid with respect to InvalidateResponse
   */
  public static InvalidateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvalidateResponse.class);
  }

  /**
   * Convert an instance of InvalidateResponse to an JSON string
   *
   * @return JSON string
   */
