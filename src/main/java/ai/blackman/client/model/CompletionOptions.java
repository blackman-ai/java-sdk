...
public class CompletionOptions {
  ...
  public CompletionOptions maxTokens(@javax.annotation.Nullable Integer maxTokens) {
  ...
  public CompletionOptions stop(@javax.annotation.Nullable List<String> stop) {
    this.stop = stop;
    return this;
  }

  public CompletionOptions addStopItem(String stopItem) {
    if (this.stop == null) {
  ...
  public CompletionOptions stream(@javax.annotation.Nullable Boolean stream) {
    this.stream = stream;
    return this;
  }
  ...
  public CompletionOptions temperature(@javax.annotation.Nullable Float temperature) {
  ...
  public CompletionOptions topP(@javax.annotation.Nullable Float topP) {
    this.topP = topP;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CompletionOptions completionOptions = (CompletionOptions) o;
    return Objects.equals(this.maxTokens, completionOptions.maxTokens) &&
        Objects.equals(this.stop, completionOptions.stop) &&
        Objects.equals(this.stream, completionOptions.stream) &&
        Objects.equals(this.temperature, completionOptions.temperature) &&
        Objects.equals(this.topP, completionOptions.topP);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(maxTokens, stop, stream, temperature, topP);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("max_tokens", "stop", "stream", "temperature", "top_p"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompletionOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompletionOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompletionOptions is not found in the empty JSON string", CompletionOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompletionOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompletionOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompletionOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompletionOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompletionOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompletionOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<CompletionOptions>() {
           @Override
           public void write(JsonWriter out, CompletionOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompletionOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompletionOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompletionOptions
   * @throws IOException if the JSON string is invalid with respect to CompletionOptions
   */
  public static CompletionOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompletionOptions.class);
  }

  /**
   * Convert an instance of CompletionOptions to an JSON string
   *
   * @return JSON string
   */
