...
import ai.blackman.client.auth.Authentication;
import ai.blackman.client.auth.HttpBasicAuth;
import ai.blackman.client.auth.HttpBearerAuth;
import ai.blackman.client.auth.ApiKeyAuth;
...
public class ApiClient {
     ...
     * @return a {@link ai.blackman.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws ai.blackman.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws ai.blackman.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws ai.blackman.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws ai.blackman.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws ai.blackman.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws ai.blackman.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws ai.blackman.client.ApiException If fails to update the parameters
     */
     ...
     * @throws ai.blackman.client.ApiException If fail to serialize the request body object into a string
     */
